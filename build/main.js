...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BARParser = __webpack_require__(2);

	var _BARParser2 = _interopRequireDefault(_BARParser);

	var _LINEParser = __webpack_require__(3);

	var _LINEParser2 = _interopRequireDefault(_LINEParser);

	var _PIEParser = __webpack_require__(4);

	var _PIEParser2 = _interopRequireDefault(_PIEParser);
	...
	var Chart = function () {
	    function Chart(element) {
	        ...
	        this.$parserMap = {
	            "bar": _BARParser2.default,
	            "line": _LINEParser2.default,
	    ...
	    _createClass(Chart, [{
	        key: "$invalidateRender",

	        // 标记echart需要重新渲染
	        value: function $invalidateRender() {
...
/***/ function(module, exports) {
	...
	exports.default = function (sources) {
	        ...
	        for (var k in item) {
	            if (k == "group") {
	                ...
	                if (indexMap[k] === undefined) {
	                    ...
	                    var name = name; //translate.get(k);
	                    series.push({ name: name, type: 'bar', data: [] });
	    ...
	    return Object.assign({
	        ...
	        legend: null,
	        series: null
	    }, { series: series, xAxis: xAxis, legend: legend });
	};
	        ...
	        for (var k in item) {
	            if (k == "group") {
	                ...
	                if (indexMap[k] === undefined) {
	                    ...
	                    series.push({ name: name, type: 'line', smooth: true, data: [] });
	                    legend.data.push(name);
	                }
	                series[indexMap[k]].data.push({ value: item[k], name: group.name, group: group });
	            }
	        ...
	        for (var k in item) {
	            if (k == "group") {
	                ...
	                if (indexMap[k] === undefined) {
	                    indexMap[k] = series.length;
	                    var name = k; //translate.get(k);
	                    series.push({ name: name, type: 'pie', data: [] });
	                }
	                series[indexMap[k]].data.push({ value: item[k], name: group.name, group: group });
	            }
	        }
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var GlobalModel = __webpack_require__(6);
	    var ExtensionAPI = __webpack_require__(28);
	    var CoordinateSystemManager = __webpack_require__(29);
	    var OptionManager = __webpack_require__(30);

	    var ComponentModel = __webpack_require__(23);
	    var SeriesModel = __webpack_require__(31);

	    var ComponentView = __webpack_require__(32);
	    var ChartView = __webpack_require__(45);
	    var graphic = __webpack_require__(46);

	    var zrender = __webpack_require__(81);
	    var zrUtil = __webpack_require__(7);
	    var colorTool = __webpack_require__(42);
	    var env = __webpack_require__(82);
	    var Eventful = __webpack_require__(36);
	    ...
	    var defaultLoadingEffect = __webpack_require__(91);
	    /**
	     * Show loading effect
	    ...
	    echarts.registerVisualCoding('echarts', zrUtil.curry(
	        __webpack_require__(92), '', 'itemStyle'
	    ));
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var Gradient = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    module.exports = {
	        getItemStyle: __webpack_require__(15)(
	            [
	                ['fill', 'color'],
	                ['stroke', 'borderColor'],
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var zrUtil = __webpack_require__(7);
	    var Element = __webpack_require__(34);
	    var BoundingRect = __webpack_require__(19);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var Eventful = __webpack_require__(36);
	    var Transformable = __webpack_require__(37);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var log = __webpack_require__(43);
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	    ...
	    var pathTool = __webpack_require__(47);
	    ...
	    graphic.Group = __webpack_require__(33);

	    graphic.Image = __webpack_require__(63);
	    ...
	    graphic.Line = __webpack_require__(76);

	    graphic.BezierCurve = __webpack_require__(77);

	    graphic.Arc = __webpack_require__(78);

	    graphic.LinearGradient = __webpack_require__(79);

	    graphic.RadialGradient = __webpack_require__(80);

	    graphic.BoundingRect = __webpack_require__(19);
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    var transformPath = __webpack_require__(62);
	    var matrix = __webpack_require__(21);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var LRU = __webpack_require__(65);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var env = __webpack_require__(82);
	    var eventTool = __webpack_require__(84);
	    var util = __webpack_require__(7);
	    var Draggable = __webpack_require__(85);
	    var GestureMgr = __webpack_require__(86);
	 ...
	 */
	    ...
	    Painter.prototype = {
	        ...
	        _pathToImage: function (id, path, width, height, dpr) {
	            ...
	            var ImageShape = __webpack_require__(63);
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    var barLayoutGrid = __webpack_require__(120);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var factory = exports;
	    ...
	    var layout = __webpack_require__(25);
	    var axisHelper = __webpack_require__(97);

	    var zrUtil = __webpack_require__(7);
	    var Cartesian2D = __webpack_require__(103);
	    var Axis2D = __webpack_require__(105);
	    ...
	    __webpack_require__(29).register('cartesian2d', Grid);
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    var OrdinalScale = __webpack_require__(98);
	    var IntervalScale = __webpack_require__(100);
	    __webpack_require__(101);
	    __webpack_require__(102);
	    var Scale = __webpack_require__(99);
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	    ...
	    var zrUtil = __webpack_require__(7);
	    var Cartesian = __webpack_require__(104);
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    var axisLabelInterval = __webpack_require__(107);
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	    ...
	    var ComponentModel = __webpack_require__(23);
	    var zrUtil = __webpack_require__(7);
	    var axisModelCreator = __webpack_require__(110);
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    var axisDefault = __webpack_require__(111);
	    var zrUtil = __webpack_require__(7);
	    var ComponentModel = __webpack_require__(23);
	    var layout = __webpack_require__(25);
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	    ...
	    var SeriesModel = __webpack_require__(31);
	    var createListFromArray = __webpack_require__(114);
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	    ...
	    var completeDimensions = __webpack_require__(117);
	    var zrUtil = __webpack_require__(7);
	    var modelUtil = __webpack_require__(9);
	    var CoordinateSystem = __webpack_require__(29);
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	    ...
	    zrUtil.extend(__webpack_require__(12).prototype, __webpack_require__(119));
	    ...
	    module.exports = __webpack_require__(5).extendChartView({
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    module.exports = {
	        getBarItemStyle: __webpack_require__(15)(
	            [
	                ['fill', 'color'],
	                ['stroke', 'borderColor'],
	                ['lineWidth', 'borderWidth'],
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    var zrUtil = __webpack_require__(7);
	    var graphic = __webpack_require__(46);
	    var AxisBuilder = __webpack_require__(124);
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    echarts.registerVisualCoding('chart', zrUtil.curry(
	        __webpack_require__(133), 'line', 'circle', 'line'
	    ));
	    echarts.registerLayout(zrUtil.curry(
	        __webpack_require__(134), 'line'
	    ));

	    // Down sample after filter
	    echarts.registerProcessor('statistic', zrUtil.curry(
	        __webpack_require__(135), 'line'
	    ));
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	    ...
	    var zrUtil = __webpack_require__(7);
	    var SymbolDraw = __webpack_require__(128);
	    var Symbol = __webpack_require__(129);
	    var lineAnimationDiff = __webpack_require__(131);
	    var graphic = __webpack_require__(46);

	    var polyHelper = __webpack_require__(132);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var zrUtil = __webpack_require__(7);
	    var symbolUtil = __webpack_require__(130);
	    var graphic = __webpack_require__(46);
	    var numberUtil = __webpack_require__(11);
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    echarts.registerVisualCoding(
	        'chart',  zrUtil.curry(__webpack_require__(141), 'pie')
	    );
	    ...
	    echarts.registerProcessor(
	        'filter', zrUtil.curry(__webpack_require__(144), 'pie')
	    );
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	    ...
	    var dataSelectableMixin = __webpack_require__(138);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// TODO minAngle
	    ...
	    var numberUtil = __webpack_require__(11);
	    var parsePercent = numberUtil.parsePercent;
	    var labelLayout = __webpack_require__(143);
	    var zrUtil = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    var TooltipContent = __webpack_require__(148);
	    var graphic = __webpack_require__(46);
	    var zrUtil = __webpack_require__(7);
	    var formatUtil = __webpack_require__(10);
	    var numberUtil = __webpack_require__(11);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var zrUtil = __webpack_require__(7);
	    var zrColor = __webpack_require__(42);
	    var eventUtil = __webpack_require__(84);
	    var formatUtil = __webpack_require__(10);
	    var each = zrUtil.each;
